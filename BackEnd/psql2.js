...
// URL: http://localhost:8080/api/events (POST 요청)
...
// URL: http://localhost:8080/api/events (GET 요청)
...
// URL: http://localhost:8080/api/events/:id (PUT 요청)
...
// URL: http://localhost:8080/api/events/:id (DELETE 요청)

// 이벤트 라우터를 '/api/events' 경로에 연결
